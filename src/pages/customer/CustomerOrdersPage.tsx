    ...
    <div className="space-y-6">
      <section className="rounded-md border border-slate-800 bg-slate-900 p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.32em] text-slate-500">Active orders</p>
            <h1 className="mt-2 text-3xl font-semibold text-white">Pending orders only.</h1>
            <p className="mt-3 text-sm leading-6 text-slate-400">
              This page shows only orders that are still pending. Everything else moves to history.
            </p>
          </div>
          <Link to="/my/history">
